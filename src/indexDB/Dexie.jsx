...
export const clearIndexedDB = async () => {
  try {
    ...
    console.log("All data from 'projects' not cleared successfully.");
  }
};


export const clearProjectIdField = async () => {
  try {
    await db.projects.toCollection().modify((project) => {
      project.projectId = null; // Set projectId to null
    });
    console.log("Cleared projectId field from all entries in projects.");
  } catch (error) {
    console.error("Failed to clear projectId field:", error);
  }
};
